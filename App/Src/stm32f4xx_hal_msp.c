...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA6     ------> ADC2_IN6
    */
    HAL_GPIO_DeInit(MOTOR_BOBINA_TENSAO_GPIO_Port, MOTOR_BOBINA_TENSAO_Pin);

    HAL_GPIO_DeInit(MOTOR_POLIA_TENSAO_GPIO_Port, MOTOR_POLIA_TENSAO_Pin);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC_MspDeInit 0 */
    ...
    PA5     ------> DAC_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, MOTOR_BOBINA_VEL_Pin|MOTOR_POLIA_VEL_Pin);
