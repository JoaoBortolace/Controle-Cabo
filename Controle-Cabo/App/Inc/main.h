...
#define MOTOR_BOBINA_TENSAO_Pin GPIO_PIN_0
#define MOTOR_BOBINA_TENSAO_GPIO_Port GPIOC
...
#define MOTOR_POLIA_TENSAO_Pin GPIO_PIN_6
#define MOTOR_POLIA_TENSAO_GPIO_Port GPIOA
